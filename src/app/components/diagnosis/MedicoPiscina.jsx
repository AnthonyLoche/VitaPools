    ...
    <div className={styles.medicoCard}>
      ...
      {!showResult && medicoStep === 2 && (
        <div className={styles.medicoStep}>
          ...
          <button className={styles.medicoBack} onClick={() => handleMedicoBack(1)}>
            ← Voltar
          </button>
        </div>
      )}
      ...
      {!showResult && medicoStep === 3 && (
        <div className={styles.medicoStep}>
          ...
          <button className={styles.medicoBack} onClick={() => handleMedicoBack(2)}>
            ← Voltar
          </button>
        </div>
      )}
      ...
      {showResult && result && (
        <div className={styles.medicoResult}>
          ...
          <h3 className={styles.medicoResultTitle}>Diagnóstico: {result.problema}</h3>
